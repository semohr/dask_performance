...
if __name__ == "__main__":
    ...
    df = dd.from_array(da.ones(10_000_000_000,chunks="250mb"), columns=["Ones"])

    # Delete old orc files
    os.system("rm /scratch03.local/smohr/dask/orc/*.orc")

    start = time.time()
    #Save to orc
    _ = df.to_orc(path="/scratch03.local/smohr/dask/orc", write_index=False)
    end = time.time()
    print(end - start)
